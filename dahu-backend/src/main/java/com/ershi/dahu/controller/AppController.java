...
import com.ershi.dahu.model.dto.app.AppAddRequest;
import com.ershi.dahu.model.dto.app.AppEditRequest;
import com.ershi.dahu.model.dto.app.AppQueryRequest;
import com.ershi.dahu.model.dto.app.AppUpdateRequest;
...
//        User user = userService.getLoginUser(request);
        ...
        if (!oldApp.getUserId().equals(userId) && !userService.isAdmin(request)) {
...
//        User loginUser = userService.getLoginUser(request);
    ...
    public BaseResponse<Boolean> doAppReview(@RequestBody ReviewRequest reviewRequest, HttpServletRequest request) {
        Boolean result = appService.doAppReview(reviewRequest, request);
