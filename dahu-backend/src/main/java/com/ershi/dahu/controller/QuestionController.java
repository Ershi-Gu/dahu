...
import com.ershi.dahu.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<Long> addQuestion(@RequestBody QuestionAddRequest questionAddRequest, HttpServletRequest request) {
        ...
        List<QuestionContentDTO> questionContentList = questionAddRequest.getQuestionContentList();
        question.setQuestionContent(JSONUtil.toJsonStr(questionContentList));
        // 数据校验
...
//        User loginUser = userService.getLoginUser(request);
    ...
    public BaseResponse<Boolean> updateQuestion(@RequestBody QuestionUpdateRequest questionUpdateRequest) {
        ...
        List<QuestionContentDTO> questionContentList = questionUpdateRequest.getQuestionContentList();
        question.setQuestionContent(JSONUtil.toJsonStr(questionContentList));
        // 数据校验
    ...
    public BaseResponse<Boolean> editQuestion(@RequestBody QuestionEditRequest questionEditRequest, HttpServletRequest request) {
        ...
        List<QuestionContentDTO> questionContentList = questionEditRequest.getQuestionContentList();
        question.setQuestionContent(JSONUtil.toJsonStr(questionContentList));
        // 数据校验
        questionService.validQuestion(question, false);
        User loginUser = UserHolder.getUser();
