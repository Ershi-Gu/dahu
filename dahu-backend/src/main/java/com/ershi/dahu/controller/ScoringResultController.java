...
import com.ershi.dahu.model.dto.scoringresult.ScoringResultAddRequest;
import com.ershi.dahu.model.dto.scoringresult.ScoringResultEditRequest;
import com.ershi.dahu.model.dto.scoringresult.ScoringResultQueryRequest;
import com.ershi.dahu.model.dto.scoringresult.ScoringResultUpdateRequest;
...
public class ScoringResultController {
    ...
    public BaseResponse<Boolean> deleteScoringResult(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可删除
        if (!oldScoringResult.getUserId().equals(loginUser.getId()) && !userService.isAdmin(request)) {
